...
public class PaddleOcrDownloadIntegrityTests
{
    ...
    public void PublishedReleaseDigest_IsPinned(string fileName, string expected)
    {
    ...
    [Fact]
    public void EveryCurrentArchiveUrl_HasPinnedDigest()
    {
    ...
    [Fact]
    public async Task DownloadAndVerifyAsync_UnknownAsset_FailsClosedBeforeRequest()
    {
